...
Ever since I joined Vitalik in the Ethereum project as co-founder in late 2013, [I’ve dreamed](https://blog.ethereum.org/2014/07/14/the-ethereum-project/) about the ways Ethereum could be used to solve some of the biggest issues we face as a civilization. 

However, it wasn't until [early 2015](http://akasha.world/#roadmap) when I first realized that we are about to create the missing puzzle piece that will enable us to tackle two of the most important challenges we face today as a modern information-based society: freedom of expression and creative perpetuity.
...
This is how, by the end of 2015, we started to understand that Meteor is great for many things but not for what we needed, especially as it started to undergo [fundamental architectural changes](http://guide.meteor.com/v1.3/1.3-migration.html). It was almost like trying to build a card castle on top of moving sands.
...
After a few weeks of intense research we found a satisfying stack for building a minimum viable product (MVP). Besides Ethereum and IPFS, our tech stack is composed of [Electron](http://electron.atom.io/), [React](http://facebook.github.io/react/) with [Redux](http://redux.js.org/) and [Node.js](https://nodejs.org/en/). 
...
From [collaborative journalism](https://en.wikipedia.org/wiki/Collaborative_journalism) to social crowdfunding, from reusable [annotations](https://en.wikipedia.org/wiki/Web_annotation) to social wikis, we see a fractal of opportunities opening in front of us.
...
[Brewster Kahle](https://en.wikipedia.org/wiki/Brewster_Kahle) is basically describing the emergent Web 3 made possible by Ethereum, and AKASHA is going to be one of the first decentralized applications giving users a glimpse at what the future of this new web might look like. 

That being said, [Ethereum](https://ethereum.org/) *is not the solution to everything* but *it is definitely an important part of a potential solution*. The same can be said about the [Inter-Planetary File System](https://ipfs.io/) and the rest of our technology stack. 
